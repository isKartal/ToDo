...
SECRET_KEY = 'django-insecure-9hko*hsy#17zi)ft-)jo)ka1*)%#!x#p$0i8ooynl6kl%!4q%e'
...
INSTALLED_APPS = [
    ...
    'rest_framework',  # API yetenekleri için
    'todo',
]
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication', # <--- BU SATIR VAR MI?
    ),
